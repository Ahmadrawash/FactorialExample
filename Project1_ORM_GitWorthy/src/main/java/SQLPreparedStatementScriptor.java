    ...
    public static PreparedStatement prepareCreateStatement(Repository repository, PreparedStatement preparedStatement, Object o) {
        ...
        try {
            ...
            for (int i = 0; i < columns.size(); i++) {
                ...
                //********* commented since because for insert statement the id won't be included (it is decalred as autoincrement**********
                //Check if the SQLTypeInt wasn't found and was set to 0
                //if (fieldTypeInt == 0) {
                ...
                preparedStatement.setString(1, ((UsersDAO)o).getName());
                preparedStatement.setString(2, ((UsersDAO)o).getPassword());
                preparedStatement.setString(3, ((UsersDAO)o).getEmail());
            ...
            //Return the parameterized prepared SQL statement
            return preparedStatement;
            //******** modified to not include the NoMatchingSQLTypeException
