...
public class Repository<O> {
    ...
    public O Update(O o) {
        //Create SQL string generated by SQLStringScriptor
        String sql = SQLStringScriptor.makeUpdateString(this);
        ...
        try {
            ...
            preparedStatement = SQLPreparedStatementScriptor.setPreparedStatementObject(((UsersDAO)o).getID(), preparedStatement, o);
    ...
    private  static void InitializeConnect() throws SQLException, IOException {
        try
        {
            ...
            connection = ConnectionManager.GetConnection(PropertiesPath);
